...
CREATE TABLE IF NOT EXISTS `Uni`.`department` (
  ...
  INDEX `IND` (`DEPTCOLLEGE` ASC) INVISIBLE,
...
CREATE TABLE IF NOT EXISTS `Uni`.`section` (
  `INSTUCTORNAME` VARCHAR(45) NOT NULL,
  ...
  INDEX `IND` (`INSTUCTORNAME` ASC) VISIBLE,
...
-- Table `Uni`.`dept2`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Uni`.`dept2` (
  `DEPTCOLLEGE` VARCHAR(45) NOT NULL,
  `COLLEGEDEAN` VARCHAR(45) NULL,
  PRIMARY KEY (`DEPTCOLLEGE`),
  CONSTRAINT `fk_department`
    FOREIGN KEY (`DEPTCOLLEGE`)
    REFERENCES `Uni`.`department` (`DEPTCOLLEGE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
